...
class NSGA3(GeneticAlgorithm):
    ...
    def __init__(self,
        ...
        if 'survival' in kwargs:
            ...
            survival = ReferenceDirectionSurvival(ref_dirs, ideal_point=ideal_point, nadir_point=nadir_point)
...
class ReferenceDirectionSurvival(Survival):
    ...
    def __init__(self, ref_dirs, ideal_point=None, nadir_point=None):
        super().__init__(filter_infeasible=True)
        self.ref_dirs = ref_dirs
        self.opt = None
        self.norm = HyperplaneNormalization(ref_dirs.shape[1], ideal_point=ideal_point, nadir_point=nadir_point)
...
class HyperplaneNormalization:
    ...
    def __init__(self, n_dim, ideal_point=None, nadir_point=None) -> None:
        super().__init__()
